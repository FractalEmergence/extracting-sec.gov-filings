                    ...
                    try:
                        ...
                        with DB_Connection.open_conn(db2_path) as conn2:
                            try:
                                ...
                                print(f"Could not migrate the {row.table_name} table to the SQL database.\n{e}")
...
# Set permission to file 644 and folder to 755
# PRAGMA table_info(Test_Table1);
...
# ORDER BY name;
#
# SELECT report_url, COUNT(*)
# FROM individual_report_links
# GROUP BY report_url
# HAVING COUNT(*) = 1
#
# SELECT  a.filing_number, a.company_name, a.filing_type, a.filing_date, b.short_name , b.report_url
...
# INNER JOIN individual_report_links b
# ON a.filing_number = b.filing_number
# WHERE b.report_url LIKE '%.xml%'
# ORDER by filing_date DESC
#
# CREATE TABLE REFERENCE_TABLE
# AS
# SELECT * FROM individual_report_links a
# INNER JOIN
# (SELECT a.filing_number,a.filing_date, a.company_name, a.cik, a.filing_type, b.name -- returns 93 rows
# FROM filing_list a
# INNER JOIN (SELECT name FROM sqlite_master -- returns 95 rows
#             WHERE type='table') b
# ON b.name LIKE '%' || a.filing_number || '%') b
# ON a.filing_number = b.filing_number
